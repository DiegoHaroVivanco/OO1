...
public class Propiedad {
	...
	public void setPolitica(Politica nuevaPolitica) {
		this.politica = nuevaPolitica;
	}
	
	public double montoDeReembolso(Reserva reserva, LocalDate fechaDeCancelacion) {
		return this.politica.montoDeReembolsdo(reserva, fechaDeCancelacion);
	}
